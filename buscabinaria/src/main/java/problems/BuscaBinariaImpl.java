...
public class BuscaBinariaImpl implements BuscaBinaria{

    @Override
    public int buscaIndexOf(int[] array, int key) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'buscaIndexOf'");
    }

    @Override
    public int ultimaOcorrencia(int[] array, int key) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'ultimaOcorrencia'");
    }
